...
# =============================================================================
# Stanley 
#ax.errorbar(Mbh[low], LSF[low], yerr=[LSF_ler[low], LSF_her[low]], fmt='s', color='green')
#ax.errorbar(Mbh[mid], LSF[mid], yerr=[LSF_ler[mid], LSF_her[mid]], fmt='s', color='green')
#ax.errorbar(Mbh[hig], LSF[hig], yerr=[LSF_ler[hig], LSF_her[hig]], fmt='s', color='green', label = 'QSO Stanley+17 (0.8<z<1.5)', alpha=0.3)
...
#ax.plot(np.array([8,11]), 10**np.array([1.71,1.71])*10**43.41, 'k--',  label='Mode of SFR of QSOs', linewidth=2, alpha=0.5) 

#ax.plot(np.array([8,11]), 10**np.array([2.1-0.5,2.1-0.5])*10**43.41, 'k',linestyle='dotted',   linewidth=2, alpha=0.5) 
#ax.plot(np.array([8,11]), 10**np.array([2.1+0.5,2.1+0.5])*10**43.41, 'k',linestyle='dotted' ,  linewidth=2, alpha=0.5) 
