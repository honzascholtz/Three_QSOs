...
LIR_sch = np.array([46, 46.5, 46, 45.6,45.6,45.8,45.7]) # from Schulze+19

Size_sch =    np.array([0.29, 0.26, 0.71, 0.51, 0.33, 0.26, 0.40])*scl # From the Schulze+19
Size_sch_er = np.array([0.07, 0.02, 0.06,0.17, 0.11,0.11,0.11])*scl # from Schulze+19
...
# =============================================================================
# Lmaperti et al submitted sub
# =============================================================================
    
L_LIR = np.array([229, 184, 44, 85, 362, 48, 384, 108])/Ken98 # Converting from SFR to LIR_SF
