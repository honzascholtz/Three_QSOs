...
# =============================================================================
    ...
    SNR = pyfits.getdata(ph.MyPATH+'Results_storage/OIII/'+ID+'_Individual_spaxel_fit.fits')[15]
    #ax.contour(SNR, levels=(3,5,10), colors=('limegreen', 'red', 'blue'))
...
# =============================================================================
    ...
    #ax.text(dx*0.05+x, dy*0.7+y, IDp,  color='white', fontsize=15)
...
for i in itere:
    ...
    #ax_low.plot(wave, (Hbw+Hbn)/max(fit), 'red', linestyle='dashed')
    
    #ax_low.plot(wave, fit/max(fit), color='red', linestyle='dashed')
