...
for ID in ['2QZJ', 'LBQS', 'HB89']:


# =============================================================================
#     Loading the narrow Halpha image
# =============================================================================
    ...
    # Extracting the BLR image
    nrmm = Image_narrow[5].copy()
    nrmm[np.isnan(nrmm)] = 0
    nrm = nrmm.max()
    
    # Extracting the Narrow emission image 
    ...
    #np.savetxt(ph.MyPATH+'/Results_storage/'+ID+'_Halpha_PSF_sub_smt.txt', image)
