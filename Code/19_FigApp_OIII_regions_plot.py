...
# =============================================================================
            ...
            Saves = emplot.load_obj('Results_storage/Spectrums/Regions/'+ID+'_OIII_'+str(iy)+'_'+str(ix))
...
# =============================================================================
    ...
    f.savefig(ph.MyPATH+'Graphs/Paper_plots/FigApp_'+ID+'_OIII_regions_wqso.pdf', bbox_inches = 'tight')
