...
#Plots =  PdfPages(PATH+'Four_quasars/Graphs/Spectra_model_plus_outflow_all_new.pdf')
...
# =============================================================================  
    ...
    if i!=2:
        ...
        out, chi2 = emfit.fitting_Halpha_mul_outflow(wave,flux,error,z, broad=1)
        ...
        out, chi2 = emfit.fitting_Halpha_mul_HB89_outflow(wave,flux,error,z, broad=1)
