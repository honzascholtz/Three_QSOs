...
Plots =  PdfPages(PATH+'Four_quasars/Graphs/Spectra_model_plus_narrow.pdf')
...
# =============================================================================  
    ...
    if i!=2:
        ...
        out, chi2 = emfit.fitting_Halpha_pr_sub_narrow(wave,flux,error,z, broad=1)
        ...
        out_old, chi2old =   emfit.fitting_Halpha_mul_LBQS(wave,flux,error,z, broad=1)
    ...
    ax1.text(6320, 1.0*max(out.eval(x=wave)), r'$\delta$BIC= %.1f' %abs(out.bic-out_old.bic), fontsize=15)
