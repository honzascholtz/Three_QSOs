...
#     
#     if (ID=='LBQS'):
#         outo, chi2 = emfit.fitting_Halpha_mul_LBQS(wave,Spectra, error,z, broad=1)
#     
#     elif ID=='HB89': 
...
# =============================================================================
    ...
    np.savetxt(PATH+'Four_Quasars/Results_storage/'+ID+'_Halpha_nuclear_flux.txt',Ha_flux)
        ...
        for iy in np.array([0,1,2]):
            ...
            if ID=='2QZJ':
                ...
                if (indx==0) :
                    ...
                    emplot.save_obj(Save_spec, 'Four_Quasars/Results_storage/Spectrums/Regions/'+ID+'_Hal_'+str(iy)+'_'+str(ix)+'_mod')
    ...
    f.savefig(PATH+'Four_Quasars/Graphs/Paper_plots/Fig9-11_'+ID+'_Halpha_regions_resinset.pdf')#, bbox_inches = 'tight')
