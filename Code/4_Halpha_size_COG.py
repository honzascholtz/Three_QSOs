...
for i in itere:   
# =============================================================================
#     Loading in the cube and masking 
# =============================================================================
    ...
    # creating array to loop over from 0.1 - 2 arcseconds in steps of 0.1 arcseconds
    rads = np.linspace(0.1,2,20)
    # Creating array to save the COGs into 
    flux_save = np.zeros((4, len(rads)))
    
    # fluxes for the narrow line COG
    flux_mes =  np.zeros_like(rads) #flux_save[1,:]
    # fluxes for the broad line COG
    ...
    # code was written for storage variable 
    storage = storage_H
    ...
    for j in arc:
        ...
        try:
            ...
            # fitting the spectrum with locked BLR compoennt 
            ...
            # Measuring the flux for NLR and BLR
