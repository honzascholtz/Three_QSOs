...
def load_cube(Full_path, z, ID, flag):
    ...
    if ID=='ALESS_75':
        header['CDELT1'] = -3.47222e-05
        header['CDELT2'] = 3.47222e-05
        header['CDELT3'] = 0.0005
    ...
    # Normalise fluxes and noise values to 1.0e-13 erg/s/cm^2/Ang to minimise numerical issues
