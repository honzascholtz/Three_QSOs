...
# ==========================================================================
    ...
    linew=2.
    ax.contour(cont_c_d,  transform= ax.get_transform(cont_c_w), colors='red', linestyles='solid' ,levels=( 2.5*rms ,3*rms,4*rms, 5*rms), alpha=0.5, linewidths=linew)
    ...
    ax.text(shapes[0]*0.05,0.8*shapes[0], ID, color='w', fontsize=12)
    ...
    if row==0:
        ax.set_title('ALMA data', fontsize=15)
...
# =============================================================================
    ...
    ax.text(300. , (lims[1]/2 ),r'r$_{e}$ = %.2f arcsec' %(Size/2.354))
...
plt.savefig(PATH+'Four_Quasars/Graphs/Paper_plots/ALMA_data_sizes.pdf', bbox_inches = 'tight')
